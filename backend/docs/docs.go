...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v1/entra/groups": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Search query (group name prefix)",
                        "name": "q",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/entra.SearchGroupsResult"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/v1/entra/users": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Search query (name, email, or UPN prefix)",
                        "name": "q",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/entra.SearchUsersResult"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/v1/settings/entra": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/httpserver.entraSettingsResponse"
                        }
                    }
                }
            },
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Entra Settings",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/httpserver.entraSettingsRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/settings/entra/test": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Entra Settings (optional, uses saved if not provided)",
                        "name": "request",
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/httpserver.entraSettingsRequest"
    ...
    "definitions": {
        ...
        "httpserver.entraSettingsRequest": {
            "type": "object",
            "properties": {
                "client_id": {
                    "type": "string"
        ...
        "httpserver.entraSettingsResponse": {
            "type": "object",
            "properties": {
                "client_id": {
                    "type": "string"
